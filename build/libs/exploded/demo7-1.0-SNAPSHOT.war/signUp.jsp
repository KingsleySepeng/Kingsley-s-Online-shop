...
<div class="form-container">
    ...
    <form action="customerServlet" method="post">
        ...
        <div class="form-group ">
            ...
            <input type="<%=passwordType%>" class="form-input" id="password" value="<%=password%>" name="password" required><br>
        </div>
            <div class="form-group <%= request.getAttribute("passwordError") != null ? "has-error" : "" %>">
                <label class="form-label" for="confirmPassword">Confirm password</label>
                <input type="<%=passwordType%>" class="form-input <%= request.getAttribute("passwordError") != null ? "has-error" : "" %>" id="confirmPassword" value<%=confirmPassword%> name="confirmPassword" required>
