...
<div class="form-container">
    ...
    <form action="customerServlet" method="post">
        ...
        <div class="form-group <%= request.getAttribute("passwordErr") != null ? "has-error" : "" %>">
            ...
            <input type="<%=passwordType%>" class="form-input <%= request.getAttribute("passwordErr") != null ? "has-error" : "" %>" id="confirmPassword" value<%=confirmPassword%> name="confirmPassword" required>
