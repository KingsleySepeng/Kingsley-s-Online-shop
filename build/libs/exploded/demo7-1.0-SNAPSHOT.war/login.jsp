...
<nav class="navbar">
    ...
    <a href="removeAccount.jsp">Delete Account</a>
</nav>
<div class="form-container">
    <div class="form-header">
        <h2>Login Page</h2>
    </div>
    <%--    changed action = "login" to action ="file_crud"--%>
    <%--    is it  possible to have >1 action for form?--%>
    <form action="customerServlet" method="post">
        ...
        <div class="form-group">
            ...
            <input type="<%=passwordType%>" class="form-input" value="<%=password%>" id="password" name="password" required>
